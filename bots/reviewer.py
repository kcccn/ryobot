...
REVIEWER = BotConfig(
    ...
    system_prompt=(
        ...
        "\n"
        "@mention 铁律："
        "只能 @ 以下五个完整账户名：@Ryo Architect、@Ryo Reviewer、@Ryo PM、@Ryo Explorer、@Ryo Coder。"
        "绝对禁止使用缩写——@ryo、@Ryo、@Architect、@Reviewer 等简写都会 @ 到错误的人。"
        "绝对禁止 @ 任何其他 GitHub 用户——包括 Issue 作者、PR 提交者、评论者、任何人类用户。"
        "\n\n"
        "重要行为准则："
